...
async function initOptimizedLoading() {
  try {
    ...
    const coreModules = [
      {
        src: 'context-monitor.js',
        name: 'context-monitor',
        priority: 'high',
        required: true,
      },
      {
        src: 'mobile-upload.js',
        name: 'mobile-upload',
        priority: 'high',
        required: true,
      },
    ...
    const extensionModules = [
      {
        src: 'context-editor.js',
        name: 'context-editor',
        priority: 'medium',
        required: false,
      },
      {
        src: 'custom-api-config.js',
        name: 'custom-api-config',
        priority: 'medium',
        required: false,
      },
      {
        src: 'mesid-floor-monitor.js',
        name: 'mesid-floor-monitor',
        priority: 'medium',
        required: false,
      },
      {
        src: 'app/weibo-app/weibo-manager.js',
        name: 'weibo-manager',
        priority: 'medium',
        required: false,
      },
      {
        src: 'app/forum-app/forum-manager.js',
        name: 'forum-manager',
        priority: 'medium',
        required: false,
      },
      {
        src: 'app/weibo-app/weibo-auto-listener.js',
        name: 'weibo-auto-listener',
        priority: 'low',
        required: false,
      },
      {
        src: 'app/forum-app/forum-auto-listener.js',
...
function fallbackToTraditionalLoading() {
  ...
  contextScript.src = 'context-monitor.js';
  ...
  uploadScript.src = 'mobile-upload.js';
  uploadScript.onload = () => {
...
contextEditorScript.src = 'context-editor.js';
...
customAPIScript.src = 'custom-api-config.js';
...
mesidFloorScript.src = 'mesid-floor-monitor.js';
...
weiboManagerScript.src = 'app/weibo-app/weibo-manager.js';
...
weiboAutoListenerScript.src = 'app/weibo-app/weibo-auto-listener.js';
...
forumManagerScript.src = 'app/forum-app/forum-manager.js';
...
forumStylesScript.src = 'app/forum-app/forum-styles.js';
...
forumAutoListenerScript.src = 'app/forum-app/forum-auto-listener.js';
...
phoneStyle.href = 'mobile-phone.css';
phoneStyle.onload = () => {
...
imageConfigStyle.href = 'app/image-config-modal.css';
...
phoneScript.src = 'mobile-phone.js';
phoneScript.onload = () => {
...
voiceMessageScript.src = 'app/voice-message-handler.js';
...
imageConfigScript.src = 'app/image-config-modal.js';
